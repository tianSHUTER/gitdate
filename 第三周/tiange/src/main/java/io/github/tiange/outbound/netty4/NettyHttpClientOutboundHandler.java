package io.github.tiange.outbound.netty4;
...
import io.github.tiange.outbound.httpclient4.NamedThreadFactory;
    ...
    public NettyHttpClientOutboundHandler(List<String> backends){
       ...
       RejectedExecutionHandler handler = new ThreadPoolExecutor.CallerRunsPolicy();
        ...
        IOReactorConfig ioReactorConfig = IOReactorConfig.
                custom().setConnectTimeout(1000).setSoTimeout(1000)
                .setIoThreadCount(cores).setRcvBufSize(32 * 1024)
                .build();
